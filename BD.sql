...
CREATE TABLE s_cliente (
    ...
    CONSTRAINT s_cliente_historial_crediticio_ck CHECK (historial_crediticio IN ('EXCELENTE', 'BUENO', 'MALO'))
);

INSERT INTO s_cliente VALUES ('301', 'Sports,Inc', '540-123-4567', '72 High St', 'Harrisonburg', 'VA', 'US', '22809', 'EXCELENTE', '12', '1', NULL);
INSERT INTO s_cliente VALUES ('302', 'Toms Sporting BUENO', '540-987-6543', '6741 Main St', 'Harrisonburg', 'VA', 'US', '22809', 'MALO', '14', '1', NULL);
...
INSERT INTO s_cliente VALUES ('205', 'Kims Sporting BUENO', '852-3693888', '15 Henessey Road', 'Hong Kong', NULL, NULL, NULL, 'EXCELENTE', '11', '4', NULL);
...
INSERT INTO s_cliente VALUES ('211', 'Helmuts Sports', '42-2111222', '45 Modrany', 'Prague', NULL, 'Czechoslovakia', NULL, 'EXCELENTE', '11', '5', NULL);
